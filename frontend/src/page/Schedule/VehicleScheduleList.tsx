...
import { getAllVehicles, getVehicleWithinDays } from "../../services/vehicleService";
...
interface VehicleScheduleListProps {
  days: number;
}

const VehicleScheduleList = ({ days } : VehicleScheduleListProps) => {
  const { isLoading, data: response } = useQuery(['vehicle-days-' + days, days.toString()], getVehicleWithinDays);
